(() => {
  ...
  function createNoise() {
    ...
    for (let index = 0; index < frameCount; index += 1) {
      ...
      previousWhite = white;
      violet = blue - previousBlue;
      previousBlue = blue;
      samples[index] = violet * 0.5; // reduce output level
    }
  ...
  function render() {
    ...
    status.textContent = isPlaying ? "Violet noise is playing" : "Ready when you are";
  }

(() => {
  ...
  function createNoise() {
    ...
    for (let index = 0; index < frameCount; index += 1) {
      ...
      // Low-pass stage
      lowState += 0.05 * (white - lowState);

      // Slower low-pass stage
      highState += 0.005 * (white - highState);

      samples[index] = (lowState - highState) * 3;
    }
  ...
  function render() {
    ...
    status.textContent = isPlaying ? "Green noise is playing" : "Ready when you are";
  }
